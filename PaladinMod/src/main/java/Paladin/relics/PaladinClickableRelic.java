...
public class PaladinClickableRelic extends CustomRelic implements ClickableRelic { // You must implement things you want to use from StSlib
    /*
    ...
    // ID, images, text.
    public static final String ID = PaladinMod.makeID("PaladinClickableRelic");

    private static final Texture IMG = TextureLoader.getTexture(makeRelicPath("Paladin_clickable_relic.png"));
    private static final Texture OUTLINE = TextureLoader.getTexture(makeRelicOutlinePath("Paladin_clickable_relic.png"));
