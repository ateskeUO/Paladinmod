...
import Paladin.powers.RarePower;

import static Paladin.PaladinMod.makeCardPath;

public class PaladinRarePower extends CustomCard {
    ...
    public static final String ID = PaladinMod.makeID("PaladinRarePower");
