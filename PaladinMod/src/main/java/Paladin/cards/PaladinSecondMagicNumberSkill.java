...
public class PaladinSecondMagicNumberSkill extends AbstractPaladinCard {
     ...
     * variables.PaladinSecondMagicNumber and cards.AbstractPaladinCard
     *
    ...
    public static final String ID = PaladinMod.makeID("PaladinSecondMagicNumberSkill");
    ...
    public PaladinSecondMagicNumberSkill() {
        super(ID, NAME, IMG, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET);

        magicNumber = baseMagicNumber = VULNERABLE;
        PaladinSecondMagicNumber = PaladinBaseSecondMagicNumber = POISON;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(
                new ApplyPowerAction(m, p, new PoisonPower(m, p, this.PaladinSecondMagicNumber), this.PaladinSecondMagicNumber));
    ...
    public void upgrade() {
        if (!this.upgraded) {
            ...
            this.upgradePaladinSecondMagicNumber(UPGRADE_PLUS_POISON);
