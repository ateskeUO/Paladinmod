...
import Paladin.powers.CommonPower;

import static Paladin.PaladinMod.makeCardPath;

public class PaladinCommonPower extends CustomCard {
    ...
    public static final String ID = PaladinMod.makeID("PaladinCommonPower");
