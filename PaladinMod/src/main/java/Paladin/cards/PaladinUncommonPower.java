...
import Paladin.actions.UncommonPowerAction;
import Paladin.characters.Paladin;

import static Paladin.PaladinMod.makeCardPath;

public class PaladinUncommonPower extends CustomCard {
    ...
    public static final String ID = PaladinMod.makeID("PaladinUncommonPower");
