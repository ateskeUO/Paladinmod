...
// public class ${NAME} extends AbstractPaladinCard
public class cardTemplate extends AbstractPaladinCard {
    ...
    public static final String ID = PaladinMod.makeID("StrikePaladin"); // PaladinMod.makeID("${NAME}");
