...
import static Paladin.PaladinMod.makeOrbPath;

public class SealOfJustice extends AbstractOrb {

    // Standard ID/Description
    public static final String ORB_ID = PaladinMod.makeID("SealOfJustice");
    ...
    private static int devotionAmount;
    ...
    public SealOfJustice() {
        ...
        if (AbstractDungeon.player.hasPower(DevotionPower.POWER_ID)){
            devotionAmount = AbstractDungeon.player.getPower(DevotionPower.POWER_ID).amount + 1;
        }
        else devotionAmount = 1;

        evokeAmount = baseEvokeAmount = devotionAmount * 7;
    ...
    public void onEvoke() { // 1.On Orb Evoke
        ...
        if (AbstractDungeon.player.hasPower(DevotionPower.POWER_ID)) {
            evokeAmount = baseEvokeAmount = 7 * devotionAmount;
            ...
            AbstractDungeon.actionManager.addToBottom( // Spend all Devotion
                    new RemoveSpecificPowerAction(AbstractDungeon.player, AbstractDungeon.player, DevotionPower.POWER_ID ));
