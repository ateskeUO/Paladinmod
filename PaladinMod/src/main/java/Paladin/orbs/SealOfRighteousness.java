...
public class SealOfRighteousness extends AbstractOrb {
    ...
    public static final String ORB_ID = PaladinMod.makeID("SealOfRighteousness");
    ...
    private static int devotionAmount = 0;
    ...
    public SealOfRighteousness() {
        ...
        if (AbstractDungeon.player.hasPower(DevotionPower.POWER_ID)){
            devotionAmount = AbstractDungeon.player.getPower(DevotionPower.POWER_ID).amount;
        }

        //evokeAmount = baseEvokeAmount = 10 * devotionAmount;
    ...
    public void onEvoke() { // 1.On Orb Evoke
        ...
        if (AbstractDungeon.player.hasPower(DevotionPower.POWER_ID)) {
            ...
            AbstractDungeon.actionManager.addToBottom( // 2.Gain block
                    new GainBlockAction(AbstractDungeon.player, AbstractDungeon.player, evokeAmount));
            AbstractDungeon.actionManager.addToBottom( // 2.Gain block
